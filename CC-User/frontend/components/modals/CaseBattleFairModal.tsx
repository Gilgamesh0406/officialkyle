...
function CaseBattleFairModal({ isOpen, setIsOpen, modalData }: Props) {
  if (!modalData) {
    return null;
  }
              ...
              <div className='flex column gap-2'>
                <div className='font-6 width-full ellipsis'>
                  ...
                  <span
                    ...
                    onClick={() =>
                      handleCopy(
                        modalData.data.game
                          ? modalData.data.game.server_seed_hashed
                          : ''
                      )
                    }
                  >
                ...
                <div className='font-6 width-full ellipsis'>
                  ...
                  <span
                    ...
                    onClick={() =>
                      handleCopy(
                        modalData.data.game && modalData.data.game?.server_seed
                          ? modalData.data.game.server_seed
                          : ''
                      )
                    }
                  >
                ...
                <div className='font-6 width-full ellipsis'>
                  ...
                  <span
                    ...
                    onClick={() =>
                      handleCopy(
                        modalData.data.game && modalData.data.game?.public_seed
                          ? modalData.data.game.public_seed
                          : ''
                      )
                    }
                  >
                ...
                <div className='font-6 width-full ellipsis'>
                  ...
                  <span
                    ...
                    onClick={() =>
                      handleCopy(
                        modalData.data.game && modalData.data.game?.nonce
                          ? modalData.data.game.nonce
                          : ''
                      )
                    }
                  >
                ...
                <div className='font-6 width-full ellipsis'>
                  ...
                  <a
                    href={
                      'https://eosflare.io/block/' + modalData.data.game?.block
                    }
                    target='_black'
                    className='keychainify-checked'
                  >
                    <span>
                      {modalData.data.game ? modalData.data.game.block : '-'}
                    </span>
                  </a>
                </div>
              </div>
...
export default CaseBattleFairModal;
